        ...
        <div class="container mx-auto p-4">
            ...
            <div v-if="currentView === 'subcategories'" class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold"><?php echo e(selectedCategoryName); ?></h2>
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div v-for="category in categories" :key="category.id" 
                        ...
                        <h3 class="font-semibold text-lg mb-2"><?php echo e(category.name); ?></h3>
                        <p class="text-gray-600 text-sm"><?php echo e(category.description || 'Click to view sub-specialties'); ?></p>
            ...
            <div v-if="currentView === 'subsubcategories'" class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-2xl font-bold"><?php echo e(selectedSubCategoryName); ?></h2>
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div v-for="category in subSubCategories" :key="category.id" 
                        ...
                        <h3 class="font-semibold text-md mb-1"><?php echo e(category.name); ?></h3>
                        <p class="text-gray-600 text-xs"><?php echo e(category.description || 'Specialty area'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div v-if="currentView === 'products'" class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold"><?php echo e(selectedCategoryName || 'Products'); ?></h2>
                ...
                <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div v-for="product in products" :key="product.id" class="border rounded-lg p-4">
                        ...
                        <p class="text-gray-600 text-sm mb-2"><?php echo e(product.description || 'No description'); ?></p>
                        <p v-if="product.price" class="text-green-600 font-medium">$<?php echo e(product.price); ?></p>
            ...
            <div v-if="currentView === 'events'" class="bg-white rounded-lg shadow p-6">
                ...
                <div v-else class="space-y-4">
                    <div v-for="event in events" :key="event.id" class="border rounded-lg p-6">
                        <h3 class="font-semibold text-xl mb-2"><?php echo e(event.title); ?></h3>
                        <p class="text-gray-600 mb-3"><?php echo e(event.description); ?></p>
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-500 mb-4">
                            <div><strong>Date:</strong> <?php echo e(event.date); ?></div>
                            <div><strong>Time:</strong> <?php echo e(event.time); ?></div>
                            <div><strong>Duration:</strong> <?php echo e(event.duration); ?></div>
                            <div><strong>Price:</strong> $<?php echo e(event.price || 'Free'); ?></div>
                        </div>
                ...
                <div v-else class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900"><?php echo e(user.phone || 'Not provided'); ?></p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900"><?php echo e(user.speciality || 'Not specified'); ?></p>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Sub-Specialty</label>
                            <p class="mt-1 text-sm text-gray-900"><?php echo e(user.sub_speciality || 'Not specified'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div v-if="currentView === 'list'" class="bg-white rounded-lg shadow p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold"><?php echo e(listTitle); ?></h2>
                    <button @click="currentView = 'dashboard'" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                        Back to Dashboard
                    </button>
                </div>
                ...
                <div v-else class="space-y-4">
                    <div v-for="item in listData" :key="item.id" class="border rounded-lg p-4">
                        <h3 class="font-semibold"><?php echo e(item.name || item.title); ?></h3>
                        <p class="text-gray-600 text-sm"><?php echo e(item.description || item.content || 'No description'); ?></p>
                        <div v-if="item.price" class="text-green-600 font-medium">$<?php echo e(item.price); ?></div>
                    </div>
                </div>
            </div>
        </div>
...
</html><?php /**PATH /var/www/html/medicalsupplierz.app/resources/views/app/dashboard.blade.php ENDPATH**/ ?>