    ...
    public function index(Request $request)
    {
        ...
        $transformedData = $products->getCollection()->map(function($item) use ($language) {
            ...
            return [
                ...
                'conference_register_link' => $item->conference_register_link,
                'conference_speakers_trainers' => $item->conference_speakers_trainers,
                'conference_datetime' => $item->conference_datetime,
                'conference_duration' => $item->conference_duration,
        ...
        try {
            ...
            $productData = [
                ...
                'warranty' => $product->warranty ? [
                    ...
                    'title' => ($language === 'ar' ? ($product->warranty->title_ar ?: $product->warranty->title_en) : ($product->warranty->title_en ?: $product->warranty->title_ar)) ?: null
                ] : null,
                'country' => $product->country ? [
                    'id' => $product->country->id,
                    'title' => ($language === 'ar' ? ($product->country->title_ar ?: $product->country->title_en) : ($product->country->title_en ?: $product->country->title_ar)) ?: null
                ] : null,
                'delivery_time' => $product->deliveryTime ? [
                    'id' => $product->deliveryTime->id,
                    'title' => ($language === 'ar' ? ($product->deliveryTime->title_ar ?: $product->deliveryTime->title_en) : ($product->deliveryTime->title_en ?: $product->deliveryTime->title_ar)) ?: null
                ] : null,
                'return_time' => $product->returnTime ? [
                    'id' => $product->returnTime->id,
                    'title' => ($language === 'ar' ? ($product->returnTime->title_ar ?: $product->returnTime->title_en) : ($product->returnTime->title_en ?: $product->returnTime->title_ar)) ?: null
                ] : null,
                'specifications' => [
                    'condition' => $product->condition ?? 'new',
                ...
                'conference_register_link' => $product->conference_register_link,
                'conference_speakers_trainers' => $product->conference_speakers_trainers,
                'conference_datetime' => $product->conference_datetime,
                'conference_duration' => $product->conference_duration,
                'conference_venue' => $product->conference_venue,
